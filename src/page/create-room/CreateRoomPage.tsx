              ...
              <div className="grid grid-cols-1 md:grid-cols-6 gap-y-6">
                ...
                <div className="col-span-4">
                  ...
                  <select
                    ...
                    value={form.type_id}
                    onChange={handleOnChange}
                    className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none transition appearance-none"
                  >
                    <option>
                      {isLoading ? "Getting Room Type... " : "Select Type"}
                    </option>
